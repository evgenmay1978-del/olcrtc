...
Java_ru_maestrovpn_app_vpn_service_MaestroVpnVpnService_startTun2socksNative(
...
Java_ru_maestrovpn_app_vpn_service_MaestroVpnVpnService_stopTun2socksNative(
...
Java_ru_maestrovpn_app_vpn_service_MaestroVpnVpnService_getTun2socksStatsNative(
    JNIEnv *env, jobject thiz)
{
    size_t tx_packets = 0;
    size_t tx_bytes = 0;
