...
/**
 * Android Quick Settings tile that toggles the MaestroVpn VPN on/off.
 *
...
class MaestroVpnQsTileService : TileService() {
    ...
    override fun onClick() {
        ...
        val isConnected = MaestroVpnVpnState.isConnected.value
    ...
    private fun startVpn() {
        val intent = Intent().apply {
            setClassName(packageName, MaestroVpnVpnActions.SERVICE_CLASS_NAME)
