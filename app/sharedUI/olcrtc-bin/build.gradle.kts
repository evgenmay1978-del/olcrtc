// The olcrtc Go sources live in the repository root (this app/ directory is a
// subfolder of the olcrtc repo). Default to the repo root; override with
// OLCRTC_REPO if building the app outside the monorepo.
val olcrtcRepoPath = providers.environmentVariable("OLCRTC_REPO")
    .orElse(rootProject.layout.projectDirectory.asFile.parentFile.absolutePath)
