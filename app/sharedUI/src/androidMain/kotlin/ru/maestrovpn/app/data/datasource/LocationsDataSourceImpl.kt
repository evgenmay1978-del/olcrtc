...
import ru.maestrovpn.app.data.ACTIVE_LOCATION_CONFIG_FILE_NAME
import ru.maestrovpn.app.data.LEGACY_LOCATIONS_BUNDLE_FILE_NAME
import ru.maestrovpn.app.data.LOCATIONS_BUNDLE_FILE_NAME
import ru.maestrovpn.app.data.model.LocationBundleV4
import ru.maestrovpn.app.vpn.data.KEY_IS_VPN_CONFIG_READY
import ru.maestrovpn.app.vpn.data.KEY_VPN_CONFIG_PATH
...
private val KEY_DEVICE_IDENTITY = stringPreferencesKey("maestrovpn_device_identity")
