...
internal val MaestroVpnDarkColorScheme = darkColorScheme(
    // MaestroVPN brand: gold primary + fiery orange/red accents on a dark base,
    // matching the eagle/fox badge icon.
    primary = Color(0xFFE7B23E),
    onPrimary = Color(0xFF3D2D00),
    primaryContainer = Color(0xFF5C4500),
    onPrimaryContainer = Color(0xFFFFDF9E),
    inversePrimary = Color(0xFF7A5A00),
    secondary = Color(0xFFE9863F),
    onSecondary = Color(0xFF4A2400),
    secondaryContainer = Color(0xFF6B3A12),
    onSecondaryContainer = Color(0xFFFFDCC4),
    tertiary = Color(0xFFE0A82E),
...
internal val MaestroVpnLightColorScheme = lightColorScheme(
