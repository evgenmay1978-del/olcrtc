...
internal class WindowsTunController(
    ...
    private suspend fun requestAdministratorRestart() {
        ...
        val currentCommand = processInfo.command().orElse(null)
            ?: error("MaestroVpn cannot resolve its Windows launcher for administrator restart")
    ...
    internal companion object {
        ...
        const val ELEVATED_START_ARGUMENT = "--maestrovpn-start-vpn-after-elevation"
